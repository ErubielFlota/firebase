...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnChangeEmail, btnChangePassword, btnSendResertEmail, btnRemoveUser, changeEmail, changePassword, sendEmail, remove, signOut;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSendResertEmail = (Button) findViewById(R.id.sending_pass_reset_button);
                ...
                if (user != null && !newPassword.getText().toString().trim().equals("")) {
                    if (newPassword.getText().toString().trim().length() < 6) {
                        ...
                        user.updatePassword(newPassword.getText().toString().trim()).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(MainActivity.this, "La contraseña se actualiza, inice sesión con una nueva contraseña!", Toast.LENGTH_SHORT).show();
                                    signOut();
                                    progressBar.setVisibility(View.GONE);
                                } else {
        ...
        btnSendResertEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
